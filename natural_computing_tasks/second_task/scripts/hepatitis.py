...
class HepatitisExperiment:
    ...
    def run(self) -> float:
        # get data from web
        dataset = DatasetsDownloader.hepatitis()
        ...
        if self._backpropagation:
            ...
            model = NeuralNetworkArchitectures.hepatitis_architecture()
...
if __name__ == '__main__':
    # example of use
    exp = HepatitisExperiment('BACKPROPAGATION')
